...
In this 10-minutes lab, you will get some hands-on experiences with **Sealed Classes** (JEP 397), a preview feature (2nd round in Java 16). This new feature enables the ability to create restricted class hierarchies. That is a class or interface that can declaratively restrict which other classes or interfaces may extend or implement them.
...
4. Create a final `AgendaRepository.java` class
